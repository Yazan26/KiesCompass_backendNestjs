...
/**
 * DAO Layer - VKM Data Access Object
 * Executes all database queries for VKM entity
 */
@Injectable()
export class VkmDao {
  constructor(
  ...
  /**
   * Get recommended VKMs (simple logic based on study credits)
   */
